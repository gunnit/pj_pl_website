...
const CARDS = [
    ...
    },
    {
        ...
        title: 'Distinct Customer Service',
        description:
            'We appreciate your contribution to testing the application and therefore we are ready to help you with any questions.'
    },
    {
        icon: '/static/images/icons/ic_design.svg',
        title: 'Limited Time Proposition',
        description:
            "Great things never last forever - don't miss the opportunity to try the BETA."
    }
];
