...
import NewProcessFormDetails from './UpdateProcessFormDetails';
...
import NewProcessFormOwnership from './UpdateProcessFormOwnership';
import NewProcessFormCharacteristics from './UpdateProcessFormCharacteristics';
import NewProcessFormRequirements from './UpdateProcessFormRequirements';
...
const useQontoStepIconStyles = makeStyles({
  ...
  completed: { color: '#1890FF', zIndex: 1, fontSize: 18 }
});
