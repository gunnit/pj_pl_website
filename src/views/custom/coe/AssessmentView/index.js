...
function getSteps() {
    return ['Main Info', 'Vision', 'Control', 'Discover', 'Deliver', 'Service', 'People', 'Technology'];
}
...
function AssessmentView() {
    ...
    function getStepContent(step) {
        switch (step) {
            case 0:
                return <MainInfo formik={formik} onOpenPreview={handleOpenPreview} />;
            case 1:
                return <VisionForm formik={formik} onOpenPreview={handleOpenPreview} />;
            case 2:
                return <div>2</div>;
            case 3:
                return <div>2</div>;
    ...
    return (
        <Page title="New Assessment" className={classes.root}>
            <Container>
                {/* Add margin to Typography */}
                <Typography variant='h4' gutterBottom>New assessment</Typography>
